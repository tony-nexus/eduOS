...
-- ── Escola HLV (3 contas) ─────────────────────────────────────
SELECT public.add_user_to_tenant('tonyragel@gmail.com',    'HLV',  'HLV Admin',       'admin');
...
SELECT public.add_user_to_tenant('thalysons122@gmail.com',      'Nexus', 'Admin Nexus',      'admin');
