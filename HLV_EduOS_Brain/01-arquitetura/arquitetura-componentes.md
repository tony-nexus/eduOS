...
├── js/
│   ├── core/
│   │   ├── init.js              ← Bootstrap: verifica sessão, monta UI, wiring do sino
│   │   ├── auth.js              ← Login/logout, currentUser, showNavForPerfil(), initNotifications()
│   │   ├── router.js            ← Roteamento hash, guard de permissões
│   │   ├── notifications.js     ← Bell agent: pagamentos, certificados, turmas; 5-min refresh
│   │   └── supabase.js          ← Cliente Supabase singleton
│   │
│   ├── ui/
│   │   ├── components.js   ← setContent(), toast() (re-export), fmtDate(), fmtMoney()
│   │   ├── toast.js        ← Toast-Anchor embedded: top-right, som, adapta CSS vars dos 4 temas
│   │   ├── date-picker.js  ← EssealDatePicker embedded: calendário adaptivo, 4 temas
